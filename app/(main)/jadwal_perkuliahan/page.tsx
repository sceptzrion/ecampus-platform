    ...
    <>
      ...
      <div className="flex flex-row h-[75px] justify-between items-center">
        ...
        <div className="flex flex-row gap-2.5 text-[14px] font-normal">
          ...
          <span className="text-[#ACB4C8]">Jadwal Perkuliahan</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 p-6 bg-white rounded-xs">
        <div className="flex w-fit border-0">
          ...
          <a className="flex items-center justify-center gap-1.5 px-3.5 py-1.75 text-sm font-medium bg-[#6658DD] text-white rounded-l-xs">
            <Image src="/burger-white.png" width={14} height={21} alt="list" />
            <span>List View</span>
          </a>
      ...
      <div className="w-full">
        <div className="flex w-full border my-6 bg-white border-gray-200 rounded overflow-hidden">
          <input
            type="text"
